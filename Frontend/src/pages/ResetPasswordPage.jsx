...
const ResetPasswordPage = () =>{
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			await axiosClient.post(`/user/reset-password/${token}`, {password:password});
	...
	return (
		...
		<motion.div
			...
			className='max-w-md w-full bg-gray-800/50 backdrop-filter backdrop-blur-xl rounded-2xl overflow-hidden shadow-[21px_20px_18px_0px_rgba(15,_15,_15,_0.56)]'
		>
			<div className='p-8'>
