...
import { loginUser } from '../autnSlice';
import { UserCircle,UserPlus, Menu,Mail ,KeyRound , Home, Info, Phone, Rocket,Lock ,Loader} from 'lucide-react';
import { motion } from 'framer-motion';
// import GlareHover from '../RareBits/GlareHover';
                        ...
                        >
                            ...
                            <h2 className='text-3xl h-auto font-bold mb-6 text-center bg-gradient-to-r from-green-400 to-emerald-500 text-transparent bg-clip-text'>
                                ...
                                <form onSubmit={handleSubmit(submittedData)} >                                 
                                    ...
                                    {/* Email ID */}
                                    {errors.emailId && (
                                    <span className="text-error ml-2 mb-1 text-s font-semibold">{errors.emailId.message}</span>
                                    )}
                                    <div className={`relative ${errors.password?'mb-2': 'mb-8'}`}>
                                    ...
                                    {/* Paassword */}
                                    {errors.password && (
                                    <span className="text-error ml-2 mb-1 text-s font-semibold">{errors.password.message}</span>
                                    )}
                                    ...
                                    <div className='flex items-center mb-4'>
                                        <NavLink to='/forgot-password' className='text-sm text-green-400 hover:underline'>
                                            Forgot password?
                                        </NavLink>
                                    </div>
