...
const ProblemPage = () => {
  ...
  return (
    <div className="h-screen flex bg-base-100" data-theme="green">
      {/* Left Panel */}
          ...
          {problem && (
            <>
              ...
              {activeLeftTab === 'editorial' && (
                <div className="prose max-w-none">
                  <h2 className="text-xl font-bold text-center mb-5 border-b-1 border-b-blue-400 pb-4">Editorial And Video Solution</h2>
                  <div className="whitespace-pre-wrap text-sm leading-relaxed">
                    {problem.secureUrl ? (
                      <Editorial
                      ...
                      <p className="text-red-600 text-4xl text-center font-semibold">🎥 No video uploaded yet</p>
                    )}
                  </div>
                </div>
              )}
          ...
          {activeRightTab === 'code' && (
            <div className="flex-1 flex flex-col">
              ...
              <div className="p-4 border-t border-base-300 flex justify-between">
                ...
                <div className="flex gap-2">
                  <button
                    className={`btn btn-neutral btn-md  ${loading ? 'loading' : ''}`}
                    onClick={handleRun}
                    disabled={loading}
                  >
                    Run
